                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Manage Blog</h5>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-header-right">
                                                            <a class="btn btn-success" href="<?= site_url() ?>admin/blog-add">Add New</a>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($data as $list) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="<?= site_url() ?>backend/Blog/editBlog/<?= $list['id'] ?>" class="btn btn-warning btn-sm">Edit</a>

                                                                                <a class="btn btn-danger btn-sm" href="<?= site_url() ?>backend/Blog/deleteData/<?= $list['id'] ?>" onclick="return confirm('Are you sure to delete this Blog?')">Delete</a>

                                                                                <?php if ($list['publised'] == "1") : ?>
                                                                                    <a href="<?= site_url() ?>backend/Blog/changeStatus/<?= $list['id'] ?>/0" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure?')">Un-Publish</a>
                                                                                <?php else : ?>
                                                                                    <a href="<?= site_url() ?>backend/Blog/changeStatus/<?= $list['id'] ?>/1" class="btn btn-info btn-sm" onclick="return confirm('Are you sure?')">Publish</a>
                                                                                <?php endif ?>
