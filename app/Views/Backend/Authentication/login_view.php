...
<head>
    ...
    <!-- ico font -->
    <link rel="stylesheet" type="text/css" href="<?= site_url() ?>assets/backend/icon/icofont/css/icofont.css">
    <!-- Font Awesome -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <?= form_open('backend/adminauthentication/checkLogin', ['class' => 'md-float-material form-material']) ?>
                    <div class="text-center">
                        <img src="<?= site_url() ?>assets/backend/images/logo.png" alt="logo.png">
                    </div>
                    <div class="auth-box card">
                        <div class="card-block">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <img src="<?= site_url() ?>assets/backend/images/auth/Logo-small-bottom.png" alt="small-logo.png">
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
    ...
    <script type="text/javascript" src="<?= site_url() ?>assets/backend/js/common-pages.js"></script>
</body>
